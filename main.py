    ...
    def start(self):
        if self.arg.phase == 'train':
            ...
            for epoch in range(self.arg.optimizer_args['start_epoch'], self.arg.optimizer_args['num_epoch']):
                ...
                if is_main_process():
                    ...
                    self.recoder.print_log(
                        "Dev WER: {:05.2f}% DEV del {:05.2f}% DEV ins {:05.2f}%".format(dev_wer['wer'], dev_wer['del'],
                                                                                        dev_wer['ins']))
                    self.recoder.print_log(
                    ...
                    self.recoder.print_log('Best_dev: {:05.2f}, {:05.2f}, {:05.2f}, '
                                           ...
                                           'Epoch : {}'.format(best_dev["wer"], best_dev["del"], best_dev["ins"],
                                                               best_tes["wer"], best_tes["del"], best_tes["ins"],
                                                               best_epoch))
                    # if save_model:
                ...
                self.recoder.print_log(
                    'Training costs {} hours {} mins {} seconds\n'.format(int(total_time) // 60 // 60,
            ...
            self.recoder.print_log('dev_wer: {:05.2f}, {:05.2f}, {:05.2f}, '
                                   'test_wer: {:05.2f}, {:05.2f}, {:05.2f},'.format(dev_wer["wer"], dev_wer["del"],
                                                                                    dev_wer["ins"],
                                                                                    test_wer["wer"], test_wer["del"],
                                                                                    test_wer["ins"]))
